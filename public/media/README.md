...
| `problem-invisible-talent.png` | "The Problem" card 1 | 4:3, 1200×900 |
| `problem-birthday-bias.png` | card 2 | 4:3, 1200×900 |
| `problem-subjective-evaluation.png` | card 3 | 4:3, 1200×900 |
| `problem-lost-knowledge.png` | card 4 | 4:3, 1200×900 |
| `og-background.png` | Behind the social card. The headline stays rendered by Satori on top — never bake text into the artwork. | exactly 1200×630 |
